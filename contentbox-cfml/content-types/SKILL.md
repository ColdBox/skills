...
// Create custom field
var field = customFieldService.new( {
	name        : "subtitle",
	label       : "Subtitle",
...
var fields = customFieldService.findByContentType( "entry" );
```
...
var subtitle = entry.getCustomFieldValue( "subtitle" );

// Get all custom field values
var fields = entry.getCustomFields();
```
...
```cfml
<!--- models/mixins/MyContentMixin.cfc --->
<cfcomponent>

	<cffunction name="getExcerpt" access="public" returntype="string">
		<cfargument name="maxLength" type="numeric" default="200">
		<cfreturn left( this.getPlainTextContent(), arguments.maxLength ) & "...">
	</cffunction>

	<cffunction name="getReadingTime" access="public" returntype="numeric">
		<cfset var wordCount = arrayLen( listToArray( this.getPlainTextContent(), " " ) )>
		<cfreturn ceiling( wordCount / 200 )>
	</cffunction>
...
var excerpt = entry.getExcerpt( 150 );
var readTime = entry.getReadingTime();
```
...
// Find by slug
var entry = entryService.findBySlug( "my-entry-slug" );

// Find by category
var entries = entryService.findByCategory( "news" );

// Find by author
var entries = entryService.findByAuthor( authorId );

// Count entries
var count = entryService.countPublishedContent( siteID : siteId );
```
...
// Find all pages
var pages = pageService.findAllWhere( { siteID : siteId, isPublished : true } );

// Find by slug
var page = pageService.findBySlug( "about" );

// Find children
var children = pageService.findChildren( parentId );

// Find hierarchical
var tree = pageService.getHierarchicalPages( siteId );
```
