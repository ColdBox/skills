...
- `Theme.bx` — metadata, settings, lifecycle callbacks
- `layouts/blog.bx`, `layouts/pages.bx` — mandatory layouts
- `views/index.bx`, `entry.bx`, `page.bx`, `archives.bx`, `error.bx` — mandatory views
